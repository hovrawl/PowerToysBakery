...
{
    public AuthenticationOAuth2(string baseURL, GrantType grant_type, string client_secret, string client_id, string scope, Client_Authentication client_authentication)
    {
